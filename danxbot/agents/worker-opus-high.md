...
description: Opus at high effort. Use for architecture - design of non-trivial stories, architecture gate reviews, cross-module invariants, security-sensitive design. The minimum for any architecture agent. Maps to danxbot card effort max.
model: opus
effort: high
---
