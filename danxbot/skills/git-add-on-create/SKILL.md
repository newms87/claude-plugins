...
Modifications to files you've already staged (or that were already tracked
before your session started) don't need this — autosave's `git add -u`
covers those automatically.
